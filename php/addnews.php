...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link" href="#">add news</a>
...
<form method="post" id="add_news" action="insertnews.php" onsubmit="return check_input();" enctype="multipart/form-data" >
...
<br>
        <div class="input-group mb-3">
            ...
            <div class="custom-file">
                ...
                <input type="file" class="custom-file-input" name="insert_image" id="insert_image" aria-describedby="inputGroupFileAddon01" accept=".jpg, .png, .gif">
                <label class="custom-file-label" for="image">Choose file</label>
            </div>
        </div>
